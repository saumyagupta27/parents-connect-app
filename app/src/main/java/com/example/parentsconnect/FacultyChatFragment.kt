...
class FacultyChatFragment : Fragment(), FragmentCallback {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_faculty_chat, container, false)
        ...
        val chatRecyclerView = view.findViewById<RecyclerView>(R.id.facultyChatRecyclerview)
        val userList = ArrayList<User>()
        val adapter = UserChatAdapter(requireContext(), userList, this)

        val cursor = db.getParentList(userId)
        val list = db.getUnreadParents(userId)
