...
class ParentSettingsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_parent_settings, container, false)
        val sharedPref = requireActivity().getSharedPreferences("parentsConnectPref", Context.MODE_PRIVATE)
        val db = DatabaseHelper(requireContext())

        val nameTextView = view.findViewById<TextView>(R.id.profileNameText)
        val emailTextView = view.findViewById<TextView>(R.id.profileEmailText)
        val imageView = view.findViewById<ImageView>(R.id.profilePicture)
        val logoutBtn = view.findViewById<Button>(R.id.logoutBtn)

        val changeNameBtn = view.findViewById<Button>(R.id.changeNameBtn)
        val changePasswordBtn = view.findViewById<Button>(R.id.changePasswordBtn)
        val changePicBtn = view.findViewById<Button>(R.id.changePictureBtn)
        ...
        changeNameBtn.setOnClickListener {
            ...
            fragmentTransaction.replace(R.id.parent_framelayout, changeNameFragment)
        ...
        changePasswordBtn.setOnClickListener {
            ...
            val fragmentManager = requireActivity().supportFragmentManager
            val fragmentTransaction = fragmentManager.beginTransaction()
            fragmentTransaction.replace(R.id.parent_framelayout, changePasswordFragment)
            fragmentTransaction.addToBackStack(null)
            fragmentTransaction.commit()
        }
        ...
        changePicBtn.setOnClickListener {
            ...
            val fragmentManager = requireActivity().supportFragmentManager
            val fragmentTransaction = fragmentManager.beginTransaction()
            fragmentTransaction.replace(R.id.parent_framelayout, changePictureFragment)
            fragmentTransaction.addToBackStack(null)
            fragmentTransaction.commit()
        }
